...
import { getTerminalDimensions, getCellPixelSize } from '../../utils/terminal';
import { APC, ST, clearScreen, clearLine, hideCursor, showCursor, moveCursor } from '../shared/ansi';
...
export class KittyRenderer {
  ...
  private renderInternal(
    ...
    this.frameNumber++;
    debugLog(`Frame #${this.frameNumber - 1}: imageId=${meta.currentImageId}, prevId=${meta.previousImageId}`);
